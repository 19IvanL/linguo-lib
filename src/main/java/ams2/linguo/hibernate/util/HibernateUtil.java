package ams2.linguo.hibernate.util;
	...
	public static SessionFactory getSessionFactory() {
		if (sessionFactory == null) {
			try {
                ...
                settings.put(Environment.URL, "jdbc:mysql://192.168.1.101:3306/linguo?createDatabaseIfNotExist=true");
...
//                configuration.addAnnotatedClass(Icons.class);
